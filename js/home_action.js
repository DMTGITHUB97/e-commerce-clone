...
$(document).ready(function () {
    $('body').on('mouseleave', '#navbarSupportedContent #navContentDiv', function (event)
    {
        $("#dropdown").hide();
    });
    ...
    $('body').on('mouseover', '#profileUl span', function (event)
    {
        var hoverText = $(this).text().toLowerCase();
        prepareCategoryDropdown(hoverText);
        $("#profileDropdown").show();
